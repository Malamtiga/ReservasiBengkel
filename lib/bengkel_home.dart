...
class Berandab extends StatefulWidget {
  const Berandab({Key? key}) : super(key: key);

  @override
  _BerandabState createState() => _BerandabState();
}

class _BerandabState extends State<Berandab> {
  double _width = 200.0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Beranda Bengkel"),
